// @ts-nocheck — legacy WebRTC/schedule code with complex runtime patterns
 ...
 * @property {{friday: string, monday: boolean, saturday: boolean, sunday: boolean, thursday: boolean, tuesday: boolean, wednesday: boolean}} days_on
 * @property {boolean} interval_on
 * @property {string} name
 * @property {string} precondition_id
 * @property {boolean} schedule_on
