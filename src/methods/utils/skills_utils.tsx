        ...
        case 'object_at_location':
            ...
            try {
                if (condition.location == 'cart'){
                    ...
                    const matchedLocations = locations.filter((loc: any) => loc._id == condition.location);
                    if (matchedLocations.length) {location = matchedLocations[0].name}
                    else {location = ''}
                }
            } catch (error) {
                location = ''
