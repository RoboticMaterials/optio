...
import {
  ...
  getDevices,
  deleteDevices,
} from "../../redux/actions/devices_actions";
  ...
  // Else its a postion/station
    ...
    const el =
      location.schema === "station"
        ? document.getElementById(`${rd3tClassName}-station`)
        : document.getElementById(`${rd3tClassName}-position`);
    let bBox = null;
    ...
    widgetInfo.xPosition =
      location.schema === "station" ? location.x + 45 : location.x + 12;
