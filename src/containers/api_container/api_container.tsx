...
const ApiContainer = (props) => {
    ...
    // Sync the local map selection to whatever the server last used.
    // This keeps tablets/phones in sync when the admin switches maps.
    useEffect(() => {
        const serverMapId = serverSettings.lastUsedMap
        if (serverMapId && serverMapId !== localSettings.currentMapId) {
            onPostLocalSettings({
                ...localSettings,
                currentMapId: serverMapId,
            })
        }
    }, [serverSettings.lastUsedMap])
