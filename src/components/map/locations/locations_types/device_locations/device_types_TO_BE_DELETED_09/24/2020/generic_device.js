...
const GenericDevice = (props) => {
    ...
    return (
        <>
            <linearGradient id="generic-gradient" x1="72.95" y1="153" x2="287.05" y2="153" gradientUnits="userSpaceOnUse">
