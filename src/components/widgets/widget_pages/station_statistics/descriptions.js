export default {
    productivity: "Productivity is the measure of the station's cycle time against the takt time of the product group. You can set the product group takt time by dragging the 'Takt' line on the balance chart in the process statistics for the process that the product group belongs to.",
    oee: "Overall Equipment Effectiveness (OEE) is the measure of the station's cycle time against the theoretical minimum cycle time for a product group at this station.",
