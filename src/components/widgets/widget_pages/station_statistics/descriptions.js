export default {
    ...
    cycleTime: "Production time is the measure of time it takes to produce a single part at this station. The average production time is estimated based on actual throughput over an entire workday broken down by product group, taking into account shift settings defined in the settings tab.",
