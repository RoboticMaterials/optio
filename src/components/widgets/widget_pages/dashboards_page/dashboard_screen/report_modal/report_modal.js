...
const NewButtonForm = (props) => {
            ...
            // create new button
                ...
                const updatedDashboard = {
                    ...
                    buttons: immutableReplace(buttons, {
                        ...dashboardButton,
                        reportButtons: [...reportButtons, newReportButton.id]
    ...
    const onDelete = () => {
        ...
        const currReportButtonIndex = reportButtons.indexOf(id)
    ...
    useEffect(() => {
        if(reportButtons !== null) {
            const matchingButtons = reportButtons.filter((currReportButtonId) => {
                return report_buttons.findIndex((currReportButton) => currReportButton.id === currReportButtonId) !== -1
            })
