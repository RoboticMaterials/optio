...
const WidgetPages = (props) => {
  ...
  return (
    <styled.Container
      ...
      id={"widgetPage"}
    >
      <styled.WidgetPageContainer showWidgetPage={showWidgetPage}>
        <Route
        ...
        />
        <Route path="/locations/:stationID/lots" component={LotsPage} />
        <Route path="/locations/:stationID/tasks" component={TasksPage} />
        <Route path="/locations/:stationID/view" component={ViewerPage} />
