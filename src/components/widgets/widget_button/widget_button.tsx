    ...
    const onDashboardClick = async () => {
        ...
        if (dashboardID === undefined) {
            ...
            postDashboardPromise.then(async postedDashboard => {
                const newDashboardId = postedDashboard._id?.$oid || postedDashboard._id

                const updatedLocation = { ...selectedLocation, dashboards: [newDashboardId] }

                await dispatchPutStation(updatedLocation, updatedLocation._id)

                history.push('/locations/' + id + '/' + type + '/' + newDashboardId)
