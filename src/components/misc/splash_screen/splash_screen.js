...
const ToggleMapViewSwitch = (props) => {
  const { checked, onChange, switchContainerStyle } = props;
...
const SplashScreen = (props) => {
  const { isApiLoaded, apiError } = props;
      ...
      {!isApiLoaded ? (
        apiError ? (
          ...
          >
            ...
            >
              ...
              <form onSubmit={handleSubmitApiIpAddress}>
                ...
                <Button
                  schema={"scheduler"}
                  style={{ color: "red", border: "0.1rem solid red" }}
                  type="submit"
                >
                  Submit
                </Button>
          ...
          >
            <i
              className={"icon-rmLogo"}
              style={{ fontSize: "10rem", margin: "3rem", color: "#FF4B4B" }}
            />
