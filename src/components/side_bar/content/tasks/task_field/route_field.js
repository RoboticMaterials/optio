    ...
    useEffect(() => {
        ...
        if(!name || !userTypedName) {
            ...
            if(loadStationId && unloadStationId) {
                ...
                setFieldValue(fieldParent ? `${fieldParent}.autoGenName` : "autoGenName", loadStation.name + " => " + unloadStation.name, false)
            }
            else if(loadStationId) {
                // setAutoGeneratedName(loadStation.name + " => ")
                setFieldValue(fieldParent ? `${fieldParent}.autoGenName` : "autoGenName", loadStation.name + " => ", false)
            }
        }
