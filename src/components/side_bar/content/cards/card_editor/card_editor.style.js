...
export const InfoText = styled.span`
  ...
  // font-weight: ${(props) => props.theme.fontWeight.bold};
  color: ${(props) =>
    props.highlight ? props.theme.schema[props.schema].solid : "white"};
`;
...
export const ProcessOption = styled.div`
  ...
  ${(props) =>
    !props.isSelected && props.containsSelected && "filter: grayscale(50%)"};
...
export const buttonViewCss = css`
  // border-right: ${(props) =>
    !props.isLast &&
    `solid ${props.theme.bg.quaternary} thin`}; // dont show border on last item
