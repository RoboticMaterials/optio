...
const LotContainer = (props) => {
  ...
  const lotFromCards = useSelector(state => state.cardsReducer.cards[lotId])
  const lotFromStationCards = useSelector(state => state.cardsReducer.stationCards?.[params.stationID]?.[lotId])
  const lot = !onDashboard ? lotFromCards : lotFromStationCards
