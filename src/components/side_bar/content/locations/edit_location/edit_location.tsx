...
const EditLocation = (props) => {
    ...
    useEffect(() => {
        return () => {
            // Pass savedRef so a successfully saved station is not removed when
            // dispatchSetEditingStation(false) unmounts this component before
            // selectedLocationRef can be updated by its own useEffect.
            onBack(savedRef.current);
        };
    }, []);
