...
const DeviceItem = (props) => {
    ...
    // const deviceTask = deviceStatus.current_task_queue_id
            ...
            {/* <styled.OEESvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 67.6 218.09">
                ...
                <g id="Layer_2" data-name="Layer 2" transform="rotate(180)">
                    <g id="Layer_1-2" data-name="Layer 1">
                        ...
                        <rect fill={batteryRectFill[1]} stroke={OEERectStroke[1]} strokeWidth='.3rem' x="25.91" y="130.42" width={batteryRectWidth} height={batteryRectWidth} rx={batteryRectRx} transform="translate(-121.38 165.29) rotate(-79.65)" />
                        <rect fill={batteryRectFill[2]} stroke={OEERectStroke[2]} strokeWidth='.3rem' x="17.6" y="96.54" width={batteryRectWidth} height={batteryRectWidth} rx={batteryRectRx} />
                        <rect fill={batteryRectFill[3]} stroke={OEERectStroke[3]} strokeWidth='.3rem' x="13.41" y="50.17" width={batteryRectWidth} height={batteryRectWidth} rx={batteryRectRx} transform="translate(-10.63 7.92) rotate(-10.35)" />
                        <rect fill={batteryRectFill[4]} stroke={OEERectStroke[4]} strokeWidth='.3rem' x="1.36" y="6.54" width={batteryRectWidth} height={batteryRectWidth} rx={batteryRectRx} transform="translate(-5.01 10.46) rotate(-20.54)" />
                    </g>
                </g>
