...
const Settings = () => {
  ...
  const { currentMap, maps } = mapReducer;
    ...
    return (
      <styled.SettingContainer>
          ...
          <Switch
            ...
            onChange={() => {
              handleUpdateLocalSettings({
                toggleDevOptions: !localSettingsState.toggleDevOptions,
              });
            }}
            onColor="red"
        ...
        {localSettingsState.toggleDevOptions ? (
          <>
            <styled.Header style={{ fontSize: "1.2rem" }}>
              Non Local API IP Address
            </styled.Header>
            ...
            <styled.RowContainer>
              <Switch
                ...
                onChange={() => {
                  handleUpdateLocalSettings({
                    non_local_api: !localSettings.non_local_api,
                  });
                }}
                onColor="red"
                style={{ marginRight: "1rem" }}
              ...
              <Textbox
                ...
                onChange={(event) => {
                  handleUpdateLocalSettings({
                    non_local_api_ip: event.target.value,
                  });
                }}
                style={{ width: "100%" }}
                // type = 'number'
            ...
            <styled.Header style={{ fontSize: "1.2rem", paddingTop: "2rem" }}>
              Devices Enabled
            </styled.Header>
            ...
            <styled.RowContainer>
              ...
              <Switch
                ...
                style={{ marginRight: "1rem" }}
              />
              <styled.Header style={{ fontSize: ".8rem", paddingTop: "1rem" }}>
                Enabled
              </styled.Header>
            </styled.RowContainer>
          </>
  ...
  const CurrentMap = () => {
    const selectedMap = maps.find(
      (map) => map._id === localSettings.currentMapId
    );
    return (
      <styled.SettingContainer>
  ...
  return (
    <styled.SettingsContainer>
      <ContentHeader
        ...
        mode={"title"}
        saveEnabled={true}
        onClickSave={handleSumbitSettings}
      />
      {MirIp()}
      {MapViewEnabled()}
      {CurrentMap()}
