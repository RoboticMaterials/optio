...
export default function ContentList(props) {
  const { executeTask, hideHeader, handleCardView, elements } = props;
  ...
  const renderLocationTypeIcon = (element) => {
    ...
    switch (element.type) {
      case "charger_position":
        return (
          <styled.LocationTypeGraphic
            fill={LocationTypes["shelf_position"].color}
            stroke={LocationTypes["shelf_position"].color}
            id="Layer_1"
            data-name="Layer 1"
      ...
      case "warehouse":
        return (
          <styled.LocationTypeGraphic
            fill={LocationTypes["warehouse"].color}
            stroke={LocationTypes["warehouse"].color}
            id="Layer_1"
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 400 400"
      ...
      case "human":
        return (
          <styled.LocationTypeGraphic
            fill={LocationTypes["human"].color}
            stroke={LocationTypes["human"].color}
            id="Layer_1"
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 400 400"
      ...
      case "cart_position":
        return (
          <styled.LocationTypeGraphic
            fill={LocationTypes["cart_position"].color}
            stroke={LocationTypes["cart_position"].color}
            id="Layer_1"
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 400 400"
    ...
    <styled.Container>
      ...
      <styled.List>
        {elements.map((element, ind) => {
          const error =
            props.schema === "processes" && element.broken ? true : false;
          return (
            <>
              <styled.ListItem
                key={`li-${ind}`}
              ...
              >
                <styled.ListItemIconContainer style={{ width: "15%" }}>
                  ...
                  {props.schema === "processes" ? (
                    error ? (
                      <div onClick={() => props.onClick(element)}>
                        <ErrorTooltip
                          visible={true}
                ...
                <styled.ListItemTitle schema={props.schema}>
                  {element.name}
