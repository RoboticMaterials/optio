...
const LocationList = (props) => {
    ...
    const currentMapId = !!localMapId ? localMapId : lastUsedMap ? lastUsedMap : maps[0]?._id
    ...
    * */
    useEffect(() => {
        ...
        let tempLocationsArr = locationsSortedAlphabetically(
            Object.values(locations).filter(loc => loc.map_id === currentMapId)
        )
