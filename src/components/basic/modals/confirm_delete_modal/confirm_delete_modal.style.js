...
const borderGlowCss = css`
  ...
  &::after {
    ...
    background: linear-gradient(
      60deg,
      /* hsl(224, 85%, 66%), */ /* hsl(269, 85%, 66%), */
        /* hsl(314, 85%, 66%), */ /* hsl(359, 85%, 66%), */ hsl(44, 85%, 66%),
      hsl(89, 85%, 66%),
      hsl(134, 85%, 66%),
      hsl(179, 85%, 66%)
    );
...
export const ButtonContainer = styled.button`
  ...
  border: none;
  box-shadow: ${(props) =>
    props.clickable ? "none" : `2px 2px 2px rgba(0, 0, 0, 0.5)`};
  ...
  ${(props) =>
    props.disabled && {
      ...
      background: `linear-gradient(180deg, rgba(255,255,255,0.4) 0%, rgba(255,255,255,0.4) 100%), ${LightenDarkenColor(
        props.background,
        -60
      )}`,
      pointerEvents: "none",
    ...
    // --border-width: 3px;
    ${(props) => props.borderGlow && borderGlowCss}
...
export const AddNewButtonContainer = styled.div`
  ...
  width: 100%;
  border-bottom: ${(props) =>
    props.showBorder && `1px solid` + props.theme.bg.tertiary};
`;
