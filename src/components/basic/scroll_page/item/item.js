...
class Item extends Component {
  ...
  render() {
    ...
    const { props, state, methods, item, itemIndex, ItemComponent, ButtonComponent, ButtonIconComponent, TextComponent, onButtonClick } = this.props;
    ...
    return (
      <ItemComponent
        ...
        onClick={(item.disabled || !props.allowItemClick) ? undefined : () => methods.addItem(item)}
