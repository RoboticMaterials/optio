...
const ListItemField = (props) => {
  ...
  const { name, new: isNew, changed, unsaved } = fieldValue;
  ...
  return (
    <Container style={containerStyle}>
      ...
      >
        ...
        <styled.ListItemTitle schema={"processes"} onClick={onTitleClick}>
          {name}
        ...
        <styled.ListItemIconContainer>
          ...
          {hasError ? (
            ...
            <ErrorTooltip
              ...
              text={
                "This route is not saved. Leaving the editor will remove the route."
              }
              className={"fas fa-exclamation-circle"}
              color={"yellow"}
              ContainerComponent={ErrorTooltipContainerComponent}
            ...
            edited && (
              <ErrorTooltip
                visible={edited}
                text={
                  "This route contains unsaved changes. Leaving the editor without saving will undo your changes."
                }
                className={"fas fa-exclamation-circle"}
                color={"yellow"}
                ContainerComponent={ErrorTooltipContainerComponent}
