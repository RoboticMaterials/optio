...
export const WidgetText = styled.span`
  font-size: ${(props) =>
    props.labelSize ? props.labelSize : props.theme.fontSize.sz6};
  ...
  color: ${(props) =>
    props.selected ? props.theme.bg.octonary : props.theme.bg.primary};
...
export const WidgetButton = styled.button`
  ...
  background-color: ${(props) =>
    props.selected ? props.theme.bg.quaternary : props.theme.bg.septenary};
