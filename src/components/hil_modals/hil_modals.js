...
const HILModals = (props) => {
    ...
    const [maxQuantity, setMaxQuantity] = useState(!!warehouse ? getBinQuantity(lot, getPreviousWarehouseStation(lot.processId, stationID).id) : getBinQuantity(cards[lotId], stationId || loadStationId))
    ...
    useEffect(() => {
        ...
        if (!!warehouse) {
            newMax = getBinQuantity(lot, getPreviousWarehouseStation(lot.processId, stationID).id)
        }
        else {
                                    ...
                                    >
                                        <LotContainer
                                            ...
                                            binId={
                                                ...
                                                !!warehouse ?
                                                    getPreviousWarehouseStation(processId, stationID).id
                                                    :
                                                    hilLoadUnload === 'load' ?
