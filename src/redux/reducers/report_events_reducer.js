  ...
  switch (action.type) {
    ...
    case GET + REPORT_EVENTS + SUCCESS:
      return Object.assign({}, state, {
        reportEvents: {
          ...state.reportEvents,
          ...action.payload.reportEventsObj,
        },
        pending: false,
      });
    ...
    case DELETE + REPORT_EVENT + SUCCESS:
      const { [action.payload.id]: old, ...rest } = state.reportEvents._id;
    ...
    case PUT + REPORT_EVENT + SUCCESS:
      return Object.assign({}, state, {
        reportEvents: {
          ...
          _id: {
            ...state.reportEvents._id,
            [action.payload.updatedReportEvent.report_button_id]:
              action.payload.updatedReportEvent,
          },
        },
        pending: false,
      });
