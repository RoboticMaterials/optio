...
import { REPORT_EVENTS, REPORT_EVENT } from "../types/data_types";
...
export const convertData = (array, key) => {
  ...
  return array.reduce((obj, item) => {
    let current = obj.station_id[item.station_id]
      ? obj.station_id[item.station_id]
      : [];
    let current1 = obj.report_button_id[item.report_button_id]
      ? obj.report_button_id[item.report_button_id]
      : [];
