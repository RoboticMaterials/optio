...
export const SORT_OPTIONS = [
  ...
  {
    description: "Quantity (Increasing)",
    sortMode: SORT_MODES.QUANTITY_ASCENDING,
  },
  {
    description: "Quantity (Decreasing)",
    sortMode: SORT_MODES.QUANTITY_DESCENDING,
  },
  {
    description: "Start Date (Ascending)",
    sortMode: SORT_MODES.START_ASCENDING,
  },
  {
    description: "Start Date (Descending)",
    sortMode: SORT_MODES.START_DESCENDING,
  },
