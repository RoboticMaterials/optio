...
export const StationTypes = {
    ...
    warehouse: {
        ...
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                viewBox="0 0 400 400">
        <path style={{fill:'none',stroke:stationColor,strokeWidth:15,strokeMiterlimit:10}} d="M334.6,357.6h-260c-16.5,0-30-13.5-30-30v-260c0-16.5,13.5-30,30-30h260c16.5,0,30,13.5,30,30v260
            C364.6,344.1,351.1,357.6,334.6,357.6z"/>
        <g>
            <path style={{fill:stationColor}} d="M224,127c5.1-2.2,9.2-3.9,9.2-3.9s4.1,1.8,9.1,4.1l24.9,11.1c5,2.2,13.3,2.5,18.5,0.6l24.6-9.2
        ...
        <g>
            <path style={{fill:stationColor}} d="M98.5,144c-5.1-1.9-9.4,1-9.4,6.5v109.7c0,5.5,4.2,11.6,9.4,13.5l89.3,33.5c5.1,1.9,9.4-1,9.4-6.5V191
        ...
        <g>
            <path style={{fill:stationColor}} d="M285.8,153.2c-5.1,1.9-9.4,8-9.4,13.5v16.1c0,5.5-4.2,11.6-9.4,13.5l-10.1,3.8c-5.1,1.9-9.4-1-9.4-6.5
    ...
    human: {
        ...
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            ...
            <path style={{fill:'none',stroke:stationColor,strokeWidth:15,strokeMiterlimit:10}} d="M334.6,357.6h-260c-16.5,0-30-13.5-30-30v-260c0-16.5,13.5-30,30-30h260c16.5,0,30,13.5,30,30v260
            C364.6,344.1,351.1,357.6,334.6,357.6z"/>
            <path style={{fill:stationColor}} d="M205.9,200.2c32.7,0,59.3-26.3,59.3-58.7s-26.5-58.7-59.3-58.7s-59.3,26.3-59.3,58.7S173.1,200.2,205.9,200.2z
