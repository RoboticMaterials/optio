...
def read_one(report_event_id):
    ...
    # Otherwise, nope, didn't find that report_event
        ...
        abort(
            404,
            "Report Event not found for Id: {report_event_id}".format(report_event_id=report_event_id),
        )


def create(report_event):
    """
    ...
    # add to collection
    report_event['datetime'] = datetime.fromtimestamp(report_event['datetime'] / 1000)
...
def update(report_event_id, report_event):
    """
    ...
    # Otherwise go ahead and update!
        ...
        result = collection.replace_one({"_id":(report_event_id)}, report_event)
