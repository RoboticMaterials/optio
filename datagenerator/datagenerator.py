...
try:
    get_ipython().system('jupyter nbconvert --to script datagenerator.ipynb')
...
optio = Optio('nikolaus@optio.cloud', 'Vaygts99', instance='localhost:5000', protocol="http")
...
#optio.curr_map_id = optio.get_map_by_name('ACME')['_id']
